        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
             ...
             <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4 align-item-center">Client</h1>
            ...
            <div class="card mb-4">
                ...
                <tr>
                    ...
                    <td><?= $row['fax'] ?></td>
                    <td><?= $row['password']?></td>
                    <td> <a  href ="clientedit.php?id=<?=$row['id']?>" class="btn btn-success">Edit</a></td> 
                    <td> <a  href ="clientremove.php?id=<?=$row['id']?>" class="btn btn-danger">Delete</a></td> 
                </tr>
