        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4 align-item-center">Lawyer Add page</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Lawyer Add page</li>
                        </ol>
                        <div class="card mb-4">
                        </div>
             </div>
            ...
            <form action="lawyerinsert.php" method="POST" enctype="multipart/form-data" style="margin-left:2%; margin-right:2%;">
               ...
               <br>
               <div class="form-group">
                <label for="exampleFormControlFile1">identification proof (Please provide your lawyer prove, such as bar council card, certificate e.t.c)</label>
