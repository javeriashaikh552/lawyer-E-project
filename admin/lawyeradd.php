    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_nav">
            ...
            <div id="layoutSidenav_content">
                ...
                <h1 class="mt-4 heading"><span><i class="fa-regular fa-star"></i></span> ADD LAWYER <span><i class="fa-regular fa-star"></i></span></h1>
            ...
            <form action="lawyerinsert.php" method="POST" enctype="multipart/form-data" style="margin-left:2%; margin-right:2%;">
                <!-- lawyer name -->
               ...
               <!-- lawyer Mobile no -->
               <div class="form-group">
                <label for="colFormLabel">Mobile no</label>
                <input type="numbers" name ="mobile" class="form-control" id="colFormLabel" placeholder="Enter mobile no">
               </div>
               <br>
               <!-- lawyer fax no -->
               <div class="form-group">
               ...
               <br>
                ...
                <div class="form-group">
                <label for="colFormLabel">Practice Area</label>
                <input type="text" name ="practice" class="form-control" id="colFormLabel" placeholder="Enter your practice area">
               </div>
               <br>
