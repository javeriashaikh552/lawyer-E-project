<?php
 ...
 $id = $_GET['id'];
 $row = mysqli_fetch_assoc(mysqli_query($conn,"select * from client where id='$id'"));
?>
<!-- php end -->
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_nav">
            ...
            <div id="layoutSidenav_content">
                ...
                <h1 class="mt-4 heading"><span><i class="fa-regular fa-star"></i></span> CLIENT EDIT <span><i class="fa-regular fa-star"></i></span></h1>
            ...
            <label for="colFormLabel" class="col-sm-2 col-form-label col-form-label">ID</label>
                ...
                <!-- laywer name -->
                <label for="colFormLabel" class="col-sm-2 col-form-label col-form-label">Client Name</label>
                <div class="col-sm-10">
                    <input type="text"  value="<?= $row['client'] ?>"  class="form-control form-control-sm" id="colFormLabel" placeholder=" Enter your Name" name="client">
                </div>
                <!-- city -->
                ...
                <!-- mobile -->
                <label for="colFormLabel" class="col-sm-2 col-form-label col-form-label">Phone no</label>
                <div class="col-sm-10">
                    <input type="numbers"  value="<?= $row['phone'] ?>" class="form-control form-control-sm" id="colFormLabel" placeholder=" Enter your phone no" name="phone">
                </div>
                <!-- fax no -->
                <label for="colFormLabel" class="col-sm-2 col-form-label col-form-label">Fax no</label>
                <div class="col-sm-10">
                    <input type="numbers"  value="<?= $row['fax'] ?>" class="form-control form-control-sm" id="colFormLabel" placeholder=" Enter your fax no" name="fax">
                </div>
                <!-- password -->
                <label for="colFormLabel" class="col-sm-2 col-form-label col-form-label">Password</label>
                <div class="col-sm-10">
                    <input type="password"  value="<?= $row['password'] ?>" class="form-control form-control-sm" id="colFormLabel" placeholder=" Enter your password" name="password">
                </div>
