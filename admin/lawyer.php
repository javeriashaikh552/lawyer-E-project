...
<php lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <h1 class="mt-4 align-item-center">Lawyer</h1>
           <ol class="breadcrumb mb-4">
            ...
            <a class="btn btn-primary" href="./lawyeradd.php" role="button">Add New Lawyer</a>
             </div>
             <br>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a  href ="lawyeredit.php?id=<?=$row['id']?>" class="btn btn-success">Edit</a></td> 
                    <td> <a  href ="lawyerremove.php?id=<?=$row['id']?>" class="btn btn-danger">Delete</a></td> 
                </tr>
