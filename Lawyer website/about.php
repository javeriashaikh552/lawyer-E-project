...
<!-- header end -->
    ...
    <div class="container-fluid">
        ...
        <!-- <div class="text-center">
            ...
            <h1 style="  font-family: 'Times New Roman', Times, serif;">Legal Advice. Strategy. Solutions.</h1>
            <p>We are proud to be recognized as one of the top business law firms in California. We help small business owners
                <br>
                 ...
                 <br>
                 <br>
               <h1  style="  font-family: 'Times New Roman', Times, serif;">How Can We Help?</h1>
