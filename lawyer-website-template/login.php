  ...
  <option value="Chicago">
    ...
    <!-- Page Header End -->
        ...
        <div class="text-center pb-2">
                <h5 class="text-uppercase mt-4">Login</h5>
                <h1 class="mb-3">Select Your Role</h1>
            </div>
<br>
            <div class="bg-appointment rounded">
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-lg-6 py-5">
                        ...
                        <br><br> <br>
                        <a href="lawyerlogin.php" >     <button class="btn btn-primary btn-block border-0 py-3" style="color:black; text-decoration:none;" >Lawyer</button></a>
                        <br> <br>
                        <h3 class="mb-3" style="color:white; text-align:center;">OR</h3>
                        <br>
                        <button class="btn btn-primary btn-block border-0 py-3"><a href="clientlogin.php" style="color:black; text-decoration:none;">Client</a></button>
                        <br><br><br>
